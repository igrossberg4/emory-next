        ...
        <div className="row">
          ...
          >
            <div className="inner-wrapper">
              ...
              <h6 className="title header-h2"><Link href={props.previous_route}>{props.previous_title}</Link></h6>
          ...
          >
            <div className="inner-wrapper">
              ...
              <h6 className="title header-h2"><Link href={props.next_route}>{props.next_title}</Link></h6>
