        ...
        {true ? (
          ...
          >
            <div className="header-inner-content">
              ...
              <div
                onTransitionEnd={(e) => {
                  ...
                  // Thanks again, iOS.
                  if (
                    e.propertyName === "z-index" &&
                    (e.target as HTMLElement).id === "video-container"
                  ) {
                    dispatch({
              ...
              <div className="header-inner-content__text">
                ...
                ></h1>
                <div className="title_expanded">{props.header_expanded}</div>
            ...
            <div className="actions">
              ...
              <div className="btn after-expand"> {props.button_scroll}</div>
            </div>
          </div>
        ) : (
          ""
