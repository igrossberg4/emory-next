...
export default function QuoteParagraphColumn(props:any) {
  return (
    <div className="quote-paragraph-column container">
      <div className="row">
        <div className="column column--quote col-md-6">
          ...
          <blockquote>
            <p className="text-body--lg" dangerouslySetInnerHTML={{__html:props.quote}}></p>
          </blockquote>
          {props.attribution && (
            <div className="quote-paragraph-column__attribution text-label" dangerouslySetInnerHTML={{__html:props.attribution}}></div>
          )}
        </div>
        <div className="column col-md-6">
          <p dangerouslySetInnerHTML={{__html:props.text}}></p>
          <div className="attribution" dangerouslySetInnerHTML={{__html:props.attribution}}></div>
        </div>
      </div>
    </div>
  );
