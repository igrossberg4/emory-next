...
export default function VideoQuote(props: any) {
  ...
  return (
    <div
      className={`section component-video-quote ${
      ...
      <div className="container">
        <div className="row video-quote__main-container">
          <div className="col-lg-7 video-quote__text-container">
            ...
            <div
              className="pretitle"
              dangerouslySetInnerHTML={{ __html: props.pretitle }}
            ></div>
            <h4
              className="title header-h4"
            ...
            ></div>
            <svg
              className="svg-quote svg-quote--bottom"
              width="69"
              height="54"
              viewBox="0 0 69 54"
              fill="none"
            ...
            >
              <path
                d="M66.5 11.1A16.1 16.1 0 0051.5 0C43 0 36 6.9 35.6 16c-.2 9 7 16.6 15.9 16.6 4 0 7.5-1.5 10.2-3.9.6-.4 1.2-.6 1.8-.6 1.6 0 3.1 1.6 2.5 3.5-2.5 9-8.8 17-17.8 21l.5 1.4a34.5 34.5 0 0018-42.9zm-35 0A16.1 16.1 0 0016.6 0 16 16 0 00.5 16c-.2 9 7 16.6 16 16.6 3.8 0 7.4-1.5 10.1-3.9.6-.4 1.2-.6 1.8-.6 1.6 0 3.1 1.6 2.6 3.5-2.6 9-8.9 17-18 21l.7 1.4a34.5 34.5 0 0017.8-42.9z"
                fill="#fff"
              />
            </svg>
          </div>
