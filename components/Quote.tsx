...
export default function Quote(props:any) {
  return (
    <div className="quote container">
      ...
      <blockquote>
        <p className="text-body--lg" dangerouslySetInnerHTML={{__html:props.text}}></p>
      </blockquote>
      {props.attribution && (
        <div className="quote__attribution text-label" dangerouslySetInnerHTML={{__html:props.attribution}}></div>
      )}
    </div>
  );
}
